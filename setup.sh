#!/bin/bash
REPO="https://raw.githubusercontent.com/x-h1/xd/main/"
clear
run_eula() {
if [ "${EUID}" -ne 0 ]; then
...
mkdir /etc/xdvpn/limit
mkdir /etc/xdvpn/limit/trojan
mkdir /etc/xdvpn/limit/vless
mkdir /etc/xdvpn/limit/vmess
mkdir /etc/xdvpn/limit/ssh
mkdir /etc/xdvpn/limit/sosck5
mkdir /etc/xdvpn/limit/socks5/ip
mkdir /etc/xdvpn/limit/socks5/quota
mkdir /etc/xdvpn/limit/ssh/ip
mkdir /etc/xdvpn/limit/trojan/ip
mkdir /etc/xdvpn/limit/trojan/quota
mkdir /etc/xdvpn/limit/vless/ip
mkdir /etc/xdvpn/limit/vless/quota
mkdir /etc/xdvpn/limit/vmess/ip
mkdir /etc/xdvpn/limit/vmess/quota
mkdir /etc/funny/log
...
url_izin='https://raw.githubusercontent.com/x-h1/xd/main/ip.txt'
...
echo -e ""
echo -e "\e[93m Telegram\e[32;1m : https://t.me/xdxl_store"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | lolcat
echo -e ""
exit 0
fi
...
frontend ssh-ssl
    bind *:443 ssl crt /etc/haproxy/xdvpn.pem
    mode tcp
    option tcplog
...
<b><font color='#B8860B'>⇱ XDXL VPN STORE ⇲</font><br> 
...
<b><font color='#66CDAA'>TELEGRAM:</font> <font color='#800000'>t.me/xdxl_store</font><br>
<b><font color='#66CDAA'>WHATSAPP :</font> <font color='#800000'>wa.me/xxx</font><br>
<b><font color='#66CDAA'>TESTIMONI:</font> <font color='#800000'>t.me/xdxl_vpn</font><br>
END
...
#ssl
cat /etc/xray/xray.crt /etc/xray/xray.key | tee /etc/haproxy/xdvpn.pem

# / / Installation Xray Service
cat > /etc/systemd/system/xray.service << END
[Unit]
Description=Xray by XDVPN
